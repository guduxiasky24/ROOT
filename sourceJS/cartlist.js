$(document).ready(function () {
	...
	var B = function () {
		var G = $("#cartNO");
		if ($("li.end").length == 0) {
			G.html("<p><span></span>\u8d2d\u7269\u8f66\u4e2d\u6682\u65f6\u6ca1\u6709\u5546\u54c1\uff01<a href='"+$www+"'><u>\u8fd4\u56de\u7ee7\u7eed\u62cd\u8d2d>></u></a></br>\u5982\u679c\u60a8\u8fd8\u672a\u767b\u5f55\uff0c\u53ef\u80fd\u5bfc\u81f4\u8d2d\u7269\u8f66\u4e3a\u7a7a\uff0c\u8bf7<a href=\""+$passport+"/login/index.html?forward=mycart\">\u9a6c\u4e0a\u767b\u5f55</a></p>");
		} else {
			G.html("");
		}
	};
	...
	$("#but_ok").bind("click", function () {
		...
		if (J.length > I) {
			...
			if(userId!=null && userId!=""){
				...
				var content = "<iframe frameborder=\"0\" style=\"width:700px;height:500px;padding:0px;overflow:auto;\" src=\""+$passport+"/login/fastLogin.html\" id=\"fastLoginFrame\" name=\"fastLoginFrame\"></iframe>";
			...
			pageDialog.PageDialog("<dl class=\"sAltFail\"><dd>"+G+"</dd></dl>","",300,50,"true","true");
		}
	});
...
//			if (J.d.Code > 0) {
//				if (J.d.Num == 1) {
//					$.PageDialog("<dl class=\"sAltFail\"><dd>\u8be5\u5546\u54c1\u672c\u671f\u7684\u60ca\u559c\u5df2\u6ee1\u5458,\u8bf7\u9009\u62e9\u4e0b\u4e00\u671f\u8fdb\u884c\u60ca\u559c\uff01</dd></dl>", {W:320, H:50, close:false, autoClose:true});
//					A.html(D() + ".00");
//					B();
//				}
//			} else {
//				alert("\u8be5\u5546\u54c1\u672c\u671f\u7684\u60ca\u559c\u4eba\u6b21\u5df2\u6ee1,\u5df2\u4ece\u8d2d\u7269\u8f66\u4e2d\u5220\u9664,\u8bf7\u9009\u62e9\u4e0b\u4e00\u671f\u8fdb\u884c\u60ca\u559c!");
//				location.reload();
//			}
//		});
//		I.OnSend($.toJSON({"codeID":H, "num":G}), "json", true);
	...
	pageDialog.PageDialog("<dl class=\"sAltOK\"><dd>\u6dfb\u52a0\u6210\u529f\uff01</dd></dl>","",160,50,"true","true");

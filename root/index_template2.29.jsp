...
<html>
	<head>
		...
		<meta property="qc:admins" content="17264246776575776375" />
...
<div class="wrapper">
	<!--头部-->
	<%-- <div class="banner-prompt clrfix" id="remind" style="background-color:#ffffef">
		<div class="w1190">
			<span class="fl"> 当天发货！注册验证手机号送1元！邀请朋友送50福分+6%消费额,可提现! 公平公正无猫腻！<a href="/news/3.html" target="_blank " style="color:#2af">充值活动</a>：充10送2、充100送5，不中有补贴。客服QQ：<a href="http://crm2.qq.com/page/portalpage/wpa.php?uin=236005004&amp;aty=1&amp;a=1001&amp;curl=&amp;ty=1" target="_blank " style="color:#2af">236005004</a></span>
		</div>
	</div> --%>
	<%-- 
	<div class="banner-prompt clrfix" id="remind" style="background-color:#ffffef">
		<div class="w1190">
			<span class="fl"> 尊敬的用户您好，本站为演示站点，为客户提供演示与技术支持，不作运营，如需购买程序<a href="https://item.taobao.com/item.htm?_u=l3jh4odb691&id=522570582906" target="_blank " style="color:#2af">点击这里</a></span>
		</div>
	</div>
	--%>
	<!--顶部-->	
         ...
         <ul class="fl">
             ...
             <li id="liMobile" class="u-arr">
                 <div class="u-menu-hd transparent-png">
                     <a href="/app/mobile.html" target="_blank" title="手机云购">手机云购</a>

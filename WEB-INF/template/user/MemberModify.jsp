...
<script type="text/javascript">
	...
	<div class="R-content">
		<input type="hidden" value="${userId }" id="userId"/>
            ...
            <div class="prompt orange"><%=ApplicationListenerImpl.sysConfigureJson.getSaitName()%>不会以任何形式公开您的个人隐私，请放心填写！完善资料可获得<%=ApplicationListenerImpl.sysConfigureJson.getUserData()%>福分。<s></s></div>
            <div class="info">
...
<!--                    </tr>-->
    ...
    <script language="javascript" type="text/javascript" src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/modify.js?data=20131121"></script>

...
<div class="R-content">
  ...
  <div class="success-invitation gray02" id="divInvited">
   ...
   <span><b></b><input type="text" onpaste="return false" value="" id="txtInfo"></span> <a class="bluebut" href="javascript:;" id="btnCopy">复制</a>
    ...
    <div style="display: none;" class="get-tips gray01" id="divInviteInfo">成功邀请 <span class="orange">${resultCount}</span> 位会员注册，已有 <span class="orange">${w}</span> 位会员参与<%=ApplicationListenerImpl.sysConfigureJson.getShortName() %>，您通过邀请获得奖励：<span class="orange">${h}</span> 福分</div>

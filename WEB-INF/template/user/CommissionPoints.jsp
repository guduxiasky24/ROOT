...
<p class="sid-line"></p><h3 url="" haschild="0" class="sid-icon07 sid-hcur"><a href="/user/MemberPoints.html"><b></b>我的福分</a></h3>
...
<div class="R-content">
	...
	<div class="member-t"><h2>我的福分</h2></div>
	<div class="over">
        <ul>
            <li><h3>可用福分：</h3><b class="orange r10">${user.commissionPoints }</b>(<%=ApplicationListenerImpl.sysConfigureJson.getShortName() %>时可抵扣现金<fmt:formatNumber type="number" value="${(user.commissionPoints/100 )-0.5} " maxFractionDigits="0"/>元)&nbsp;&nbsp;<a title="如何获得福分" target="_blank" href="/help/userExperience.html">如何获得福分？</a></li>
        </ul>
    </div>

                    ...
                    <div class="ng-goods-detail">
                            ...
                            <div class="my-buy clearfix">
                                ...
                                <div id="divNumber" class="option-wrapper clearfix">
                                    ...
                                    <input type="text" class="input-num" value="${productInfo.singlePrice==100?100:productInfo.singlePrice==10?10:1}" />
                                    <a href="javascript:;" class="add">+</a>
                                    
                                </div>
                                <c:if test="${productInfo.spellbuyLimit==0}">
                                	<ul class="check-num clearfix">
                                		<c:if test="${(productInfo.productPrice - productInfo.spellbuyCount)<10 && productInfo.singlePrice!=100}">
	                                		<li>${productInfo.productPrice - productInfo.spellbuyCount }</li>
	                                	</c:if>
	                                	<c:if test="${(productInfo.productPrice - productInfo.spellbuyCount)>10 && productInfo.singlePrice!=100}">
	                                		<li>10</li>
	                                	</c:if>
	                                	<c:if test="${(productInfo.productPrice - productInfo.spellbuyCount)>10 && (productInfo.productPrice - productInfo.spellbuyCount)< 20 && productInfo.singlePrice!=100}">
	                                		<li>${productInfo.productPrice - productInfo.spellbuyCount }</li>
	                                	</c:if>
	                                	<c:if test="${(productInfo.productPrice - productInfo.spellbuyCount)>20 && (productInfo.productPrice - productInfo.spellbuyCount)< 50 && productInfo.singlePrice!=100}">
	                                		<li>${productInfo.productPrice - productInfo.spellbuyCount }</li>
	                                	</c:if>
	                                	<c:if test="${(productInfo.productPrice - productInfo.spellbuyCount)>50 && productInfo.singlePrice!=100}">
	                                		<li>50</li>
	                                	</c:if>

...
<body id="loadingPicBlock" rf="2">
    ...
    <input name="hidShowCalcTime" type="hidden" id="hidShowCalcTime" value="${latestlottery.announcedTime }"/>
    ...
    <input name="hidSscNum" type="hidden" id="hidSscNum" value="${latestlottery.sscNumber}" />
    <input name="hidSscPeriods" type="hidden" id="hidSscPeriods" value="${latestlottery.sscPeriod}" />
                ...
                <div class="ng-result-detail">
                    <div class="result-con-wrapper">
                        ...
                        <div class="result-how">
                            ...
                            <p>2、按时、分、秒、毫秒排列取值和"老时时彩"最近一期开奖结果之和，除以该商品总参与人次后取余数；</p>

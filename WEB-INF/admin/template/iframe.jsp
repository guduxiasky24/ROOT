...
<div id="header">
    ...
    <a target="_blank" title="官方网站" href="http://www.yiydb.cn">官方网站</a>
    </div>xw
...
<div id="left">
    <ul id="setting" class="left_date" style="display: none;">   
		...
		<li><a src="/admin_back/logListAll.action" href="javascript:;">日志管理</a></li>
...
<!--        <li><a src="/admin_back/shareList.action?typeId=hot20" href="javascript:;">晒单评论管理</a></li>-->
     ...
     <ul id="user" class="left_date" style="display: none;">   
        ...
        <li><a src="/admin_back/agentListAll.action" href="javascript:;">代理商列表</a></li> 	

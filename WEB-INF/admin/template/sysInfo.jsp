...
<div class="div-user lr10">
	<h1>Hello, <font color="#4c95b6"><%= ((Admin)request.getSession().getAttribute("admin")).getUserName() %></font></h1><h1>
...
<div class="bk15"></div>
	<ul >
    	<li><a style="color:#09c;" href="/admin_back/toAddNews.action"><img src="/admin_img/134.png" /><span>添加新闻</span></a></li>
        <li><a style="color:#09c;" href="/admin_back/toAddProduct.action"><img src="/admin_img/132.png" /><span>添加商品</span></a></li>
        <li><a style="color:#09c;" href="/admin_back/userListAll.action"><img src="/admin_img/148.png" /><span>会员管理</span></a></li>
        <li><a style="color:#09c;" href="/admin_back/toBasicSet.action"><img src="/admin_img/130.png" /><span>系统设置</span></a></li>
...
<li>如果您还在使用 IE8 的版本就out了，操作后台请升级浏览器内核至IE9或使用谷歌,火狐,opera,浏览器！</li></div>
<div class="bk10"></div>
...
<!------------>
    <div class="div-system width30">
        <div class="title">系统信息</div>
            ...
            <ul>        
                ...
                <li><i>网站名称: </i>${sysConfigure.saitTitle }</li>
    ...
    <div class="div-about width30" id="sysInfo">
        ...
        <div class="bk10"></div>
        <ul>
        	<li><i>程序版本:</i>V1.0.1<font color="#f60">【商业版】</font></li>
			<li><i>更新时间:</i>2016.05.29</li>
            <li><i>程序开发:</i>微纳科技有限公司</li>
            <li><i>版权所有:</i>微纳科技有限公司</li>
            <li><i>官方微博:</i><a style="color:#0f0" target="_black" href="#">关注官方微博</a></li>        
        </ul>
            <!-- <p style="color:#666; padding:20px;font: 12px/1.5 tahoma,arial,宋体b8b\4f53,sans-serif;">
            	欢迎使用惊喜云购源码，本源码为 java 语言编写，拥有最好的安全性能，程序可部署集群服务，不怕人气爆棚，该程序不邦定域名，不做任何限制，

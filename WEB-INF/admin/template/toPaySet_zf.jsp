...
<!--start-->
  <table width="100%" cellspacing="0">
    ...
    <tbody>
		...
		<tr>
			<td align="center">智付支付</td>	
			<td align="center">
			<div  style="background-image:url('/Images/dinPay.png'); background-repeat:repeat;background-attachment:scroll;background: url('/Images/dinPay.png') repeat scroll 3px 0 rgba(0, 0, 0, 0);height: 36px;width: 120px;border: 1px solid #ddd;text-indent: -9999px;background-color: #fff;">智付支付
			</div>
			</td>
			<td align="center">
				<%
			...
			<td align="center"><a href="/admin_back/payInfo.action?id=dinPay">设置</a>  <a href="http://www.dinpay.com/" target="_blank"><font style="color:#0c0">申请接口</font></a></td>
		</tr>

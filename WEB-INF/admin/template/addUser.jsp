...
<input type="hidden" name="user.userType" value="0"/>
  <table width="100%" cellspacing="0">
  	 <tbody><tr>
		...
		<tr>
			<td width="120" align="right">职业：</td>
			<td><input type="text" class="input-text" value="${user.job }" name="user.job" /></td>
		</tr>
		<tr>
			<td width="120" align="right">年龄 ：</td>
			<td><input type="text" class="input-text" value="${user.age }" name="user.age" /></td>
		</tr>
		<tr>
			<td width="120" align="right">地址：</td>
			<td><input type="text" class="input-text" value="${user.location }" name="user.location" /></td>
		</tr>
		<tr>
			<td width="120" align="right">代理区域：</td>
			<td><input type="text" class="input-text" value="${user.agentAddress }" name="user.agentAddress" /></td>
		</tr>
		<tr>
			<td width="120" align="right">代理状态：</td>
			<td><input type="text" class="input-text" value="${user.agentState }" name="user.agentState" />0. 未审核1.审核通过2.审核不通过</td>
		</tr>
		<tr>
